            ...
            <div id="multi-step-form-container">
                <ul className="form-stepper form-stepper-horizontal text-center mx-auto pl-0">
                    ...
                    <span className="form-stepper-circle">
                        <span> <img src="/images/logo/Plogo-2.png" alt="" width={95}/></span>
                    </span>
                    ...
                    <span className="form-stepper-circle text-muted">
                        <span><img src="/images/logo/Plogo-3.png" alt="" width={95}/></span>
                    </span>
                    ...
                    <li className="form-stepper-unfinished text-center form-stepper-list" step="3">
                        <a className="mx-2">
                    <span className="form-stepper-circle text-muted">
                        <span><img src="/images/logo/Plogo-4.png" alt="" width={95}/></span>
                    </span>
                ...
                <form id="userAccountSetupForm" name="userAccountSetupForm" encType="multipart/form-data" method="POST">
                    <section id="step-1" className="form-step">
                        ...
                        <div className="mt-3">
                            <button className="button btn-navigate-form-step btn-twentyOne fw-500 tran3s" type="button"
                                    step_number="2">Next
                            </button>
                        </div>
                    </section>
                    ...
                    <section id="step-3" className="form-step d-none">
                        ...
                        <div className="mt-3">
                            ...
                            <button className="button submit-btn btn-twentyOne fw-500 tran3s" type="submit"
                                    step_number="1">Finish
                            </button>
                        </div>
                    </section>
                </form>
